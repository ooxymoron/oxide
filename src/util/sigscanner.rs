...
pub fn find_sig<T>(module: &str, sig: &str) -> OxideResult<*mut T> {
    unsafe {
        ...
        for i in 0..mod_size {
            ...
            if matches {
                ...
                return Ok(if *start == 0xE8 {
                    // relative call
                    let asm_ptr = *(start.add(1) as *const usize);
        ...
        return Err(OxideError::new("sig not found"));
    }
}
